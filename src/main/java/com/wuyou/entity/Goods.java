...
public class Goods {
    ...
    public Short getVirtualLimit() {
        return virtualLimit;
    }

    public void setVirtualLimit(Short virtualLimit) {
        this.virtualLimit = virtualLimit;
    }

    public Boolean getVirtualRefund() {
        return virtualRefund;
    }

    public void setVirtualRefund(Boolean virtualRefund) {
