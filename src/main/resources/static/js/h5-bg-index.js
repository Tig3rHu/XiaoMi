	let max_particles    = 100;
		...
		var tela = document.createElement('canvas');
		    tela.width = $("#h5-bg-index").width();
		    tela.height = $("#h5-bg-index").height();
		    $("#h5-bg-index").append(tela);
		...
		class Particle{
		  constructor(canvas, options){
		    ...
		    this.x = ($("#h5-bg-index").width()/2)  + (Math.random()*200 - Math.random()*200)
		    this.y = ($("#h5-bg-index").height()/2) + (Math.random()*200 - Math.random()*200)
		    this.w = $("#h5-bg-index").width()
		    this.h = $("#h5-bg-index").height()
